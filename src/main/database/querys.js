 ...
 */
export function selectSQL (query = {}, tabla) {
    var sql = ''
    let { fields } = query
    var inner = ''
 ...
 * @param tabla model of the table
 */
export function selectSQLOne (id, query, tabla) {
    var sql = ''
    let { fields } = query
    var inner = ''
 ...
 */
export function selectByFilter (query, tabla, filter, id) {
    var sql = ''
    let { fields } = query
    var inner = ''
...
export function makeWhere (query, tabla, ind) {
    let where = ''
    var index = ind || 0
    for (const prop in query) {
...
export function makeInsert (object) {
    let insert = ''
